...
def go_room():
    ...
    driver.refresh()
    WebDriverWait(driver, 30, 0.5).until(lambda drivers: drivers.find_element(By.XPATH, "/html/body/section/header/div"
                                                                                        "/div/div[3]/div[7]/div"))
    a = driver.find_element(By.XPATH, "/html/body/section/header/div/div/div[3]/div[7]/div")
